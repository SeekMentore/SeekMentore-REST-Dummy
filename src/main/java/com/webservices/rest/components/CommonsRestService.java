...
public class CommonsRestService extends AbstractRestWebservice implements RestMethodConstants, CommonsConstants {
	...
	public String getLoginBasicInfo (
		...
		admin.addSubMenu("Control Panel", "/user/employee/superadmin/controlpanel");
		...
		support.addSubMenu("Tutor Registrations", "/user/employee/support/tutorregistration");
		support.addSubMenu("Enquiry Registrations", "/user/employee/support/enquiryregistration");
		support.addSubMenu("Query Submitted", "/user/employee/support/querysubmitted");
		support.addSubMenu("Subscriptions Requested", "/user/employee/support/subscriptionrequested");
		support.addSubMenu("User Complaints", "/user/employee/support/complaints");
